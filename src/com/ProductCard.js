...
// import wish from "../images/wish-black.svg";
...
import wishRed from '../images/Heart_icon_red_hollow.svg.png';
              ...
              <div
                ...
                <div className="action-bar position-absolute">
                  <div className="d-flex flex-column gap-15">
                    ...
                    <button className='border-0 bg-transparent' onClick={(e) => { addToWish(item?._id) }}> <img src={prodcompare} alt="wishlist" /></button>
