...
const Home = () => {
  ...
  return (
    <>
      ...
      <Container class1="featured-wrapper py-5 home-wapper-2">
        <div className="row">
          <div className="col-12">
      ...
      <Container class1="famous-wrapper py-5 home-wapper-2">
        <div className="row">
          <div className="col-3">
      ...
      <Container class1="special-wrapper py-5 home-wapper-2">
        <div className="row">
          <div className="col-12">
      ...
      <Container class1="popular-wrapper py-5 home-wapper-2">
        <div className="row">
          <div className="col-12">
      ...
      <Container class1="marque-wrapper home-wapper-2 py-5">
        <div className="row">
          <div className="col-12">
